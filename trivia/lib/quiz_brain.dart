import 'package:trivia/data_model.dart';
...
class QuizzBrain {
  ...
  List<DataModel> _questionList = [
    ...
    DataModel('In London, UK, if you happen to die in the House of Parliament, you are technically entitled to a state funeral, because the building is considered too sacred a place.', true),
    DataModel('The loudest sound produced by any animal is 188 decibels. That animal is the African Elephant.', false),
    ...
    DataModel('Chocolate affects a dog\'s heart and nervous system; a few ounces are enough to kill a small dog.', true),
    DataModel('In West Virginia, USA, if you accidentally hit an animal with your car, you are free to take it home to eat.', true)
  ];
  ...
  bool isFinished() {
    return _questionCount >= _questionList.length - 1;
  }
